...
public class KaraokeMachine {
    ...
    private String promptForSingerName() throws IOException {
        ...
        return mReader.readLine();  // prompts a suggestion to add throws IOException
    }
    ...
    public void playNext() {
        // Refactor with CTRL(^)+T: song -> songRequest
        ...
        if (songRequest == null) {
            ...
            System.out.printf("%n%n%n Are you Ready %s? Open %s to hear %s by %s %n%n%n",
                    ...
                    // Added .getSong() to all songRequest() lines below with OPT+SHIFT + cursor click (multi-cursor).
                    // Then, refactored extracting the variable named song, declared above
                    song.getVideoUrl(),
                    song.getTitle(),
                    song.getArtist());
        }
